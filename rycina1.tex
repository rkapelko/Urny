...
\end{center}
  \caption{Example of system of connected urns.  Graph $\mathcal{G}=(\{1,2,3,4,5\},\{(1,2),(2,3),(2,4),(3,5),(4,5)\})$ \label{fig:general} just after round $t=8$ (left side)  and just after round $t=9$ (right side). For each $a\in \{1,2,3,4,5\}$  $n_a=4$. In the picture $B_{1}(8)=B_{1}(9)=4$, $B_{4}(9)=W_{4}(9)=2$.}
\end{figure*}
